import argparse
from src.analyses.drift import run_drift_by_count
...
def main():
    ...
    ap.add_argument("--window_size", type=int, default=1000, help="Number of frames per window")
    ap.add_argument("--hop", type=int, default=500, help="Hop size (frames) between windows")
    ap.add_argument("--sample_per_window", type=int, default=400, help="Rows sampled per window")
    ap.add_argument("--pca_dim", type=int, default=50)
    ap.add_argument("--bootstrap_per_run", type=int, default=2000)
    ap.add_argument("--seed", type=int, default=42)
    ap.add_argument("--no_plots", action="store_true", help="Disable PNG plots")
    args = ap.parse_args()

    res = run_drift_by_count(
